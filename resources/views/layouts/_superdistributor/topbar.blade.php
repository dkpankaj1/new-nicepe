<div class="topbar-custom">
    <div class="container-fluid">
            ...
            <ul class="list-unstyled topnav-menu mb-0 d-flex align-items-center">
                ...
                <li class="dropdown notification-list topbar-dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end profile-dropdown ">
                        ...
                        <!-- item-->
                        <a href="{{route('superdistributor.account.index')}}" class="dropdown-item notify-item">
                            <i class="mdi mdi-account-circle-outline fs-16 align-middle"></i>
                            <span>My Account</span>
                        </a>

                        <!-- item-->
                        <a href="{{route('superdistributor.account.update')}}" class="dropdown-item notify-item">
                            <i class="mdi mdi-lock-outline fs-16 align-middle"></i>
                            <span>Profile Update</span>
                        </a>

                        <!-- item-->
                        <a href="{{route('superdistributor.account.password')}}" class="dropdown-item notify-item">
                            <i class="mdi mdi-lock-outline fs-16 align-middle"></i>
        ...
        <form action="{{route('superdistributor.logout')}}" method="post" id="userLogoutForm">
            @csrf
        </form>
    </div>
