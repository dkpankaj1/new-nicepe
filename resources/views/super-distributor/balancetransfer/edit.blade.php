<x-app-layout>
    ...
    @section('breadcrumb', Breadcrumbs::render('superdistributor.balance-transfers.edit', $balanceTransfer))
    <!-- Start Content-->
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('superdistributor.balance-transfers.update', $balanceTransfer) }}" method="POST">
                    @csrf
                    @method('put')
