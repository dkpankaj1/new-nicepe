<x-app-layout>
    ...
    @section('breadcrumb', Breadcrumbs::render('distributor.balance-transfers.edit', $balanceTransfer))
    <!-- Start Content-->
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('distributor.balance-transfers.update', $balanceTransfer) }}" method="POST">
                    @csrf
                    @method('put')
