<x-app-layout>
    ...
    @section('breadcrumb',Breadcrumbs::render('distributor.wallet.show',$transaction))
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <p>
                        ...
                        <strong>Net Amount:</strong> {{ number_format($transaction->amount, 2) }}
                        {{ $transaction->currency->code }}<br>
                        <strong>Opening Balance:</strong> {{ number_format($transaction->opening_balance, 2) }}
                        {{ $transaction->currency->code }}<br>
                        <strong>Closing Balance:</strong> {{ number_format($transaction->closing_balance, 2) }}
