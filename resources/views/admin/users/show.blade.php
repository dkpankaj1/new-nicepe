<x-app-layout>
    ...
    @section('breadcrumb', Breadcrumbs::render('admin.users.show', $user))
    <!-- Start Content-->
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="country" class="form-control">
                            ...
                            <option value="{{ $country->name }}" @if ($country->name === old('country', $user->country))
                            selected @endif>
                                {{ $country->name }}
                            </option>
                        </select>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="state" class="form-control">
                            ...
                            @foreach ($country->states as $state)
                                <option value="{{ $state->name }}" @if ($state->name === old('state', $user->state)) selected
                                @endif>
                                    {{ $state->name }}
                                </option>
                            @endforeach
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="role" class="form-control">
                            ...
                            @foreach ($roles as $role)
                                <option value="{{$role->name}}" @if(old('role', $user->getRoleNames()[0]) == $role->name)
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="is_active" class="form-control">
                            ...
                            <option value="0" @if(old('is_active', $user->active) == "0") selected @endif>in-active
                            </option>
                        </select>
                        @error('is_active')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
