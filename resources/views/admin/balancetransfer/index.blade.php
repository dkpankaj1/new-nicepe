<x-app-layout>
    ...
    @section('breadcrumb', Breadcrumbs::render('admin.balance-transfers.index'))
    <!-- Start Content-->
            ...
            @can('balance-transfers.index')
                <div class="card-header">
                    <div class="d-flex justify-content-end align-items-center">
                        <a href="{{route('admin.balance-transfers.create')}}" class="btn btn-primary px-3"> Add</a>
                    </div>
                </div><!-- end card header -->
            @endcan
            <div class="card-body">
                <x-datatable id="datatable" ajaxUrl="{{route('admin.balance-transfers.index')}}" :columns="[
