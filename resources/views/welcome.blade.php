...
<body>
    <ul>
        <li><a target="_blank" href="{{route('admin.login')}}">Admin Login</a></li>
        <li><a target="_blank" href="{{route('apiclient.login')}}">Api Client Login</a></li>
        <li><a target="_blank" href="{{route('superdistributor.login')}}">Super Distributor Login</a></li>
        <li><a target="_blank" href="{{route('distributor.login')}}">Distributor Login</a></li>
        <li><a target="_blank" href="{{route('retailer.login')}}">Retailer Login</a></li>
    </ul>
</body>
...
<head>
    ...
    <meta name="description" content="{{$brandSetting->title}}">
...
<body class="index-page">
    ...
    <header id="header" class="header d-flex align-items-center fixed-top">
        <div
            ...
            <a href="/" class="logo d-flex align-items-center me-auto me-xl-0">
                ...
                <h1 class="sitename">{{$brandSetting->name}}</h1>
            </a>
            ...
            <nav id="navmenu" class="navmenu">
                <ul>
                    ...
                    <li class="dropdown"><a href="#"><span>Login</span> <i
                        ...
                        <ul>
                            <li><a href="{{route('apiclient.login')}}">Api Client</a></li>
                            <li><a href="{{route('superdistributor.login')}}">Super Distributor</a></li>
                            <li><a href="{{route('distributor.login')}}">Distributor</a></li>
                            <li><a href="{{route('retailer.login')}}">Retailer </a></li>
                        </ul>
                    </li>
                </ul>
            ...
            <a class="btn btn-getstarted" href="#about">Get Started</a>
                ...
                <div class="row align-items-center">
                        ...
                        <div class="hero-content" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div class="hero-buttons">
                                <a href="https://www.youtube.com/watch?v=Y7f98aduVJ8"
                                    class="btn btn-primary me-0 me-sm-2 mx-1 glightbox">
                    ...
                    <div class="col-lg-6">
                        <div class="hero-image" data-aos="zoom-out" data-aos-delay="300">
                            <img src="{{asset('frontend/img/illustration-1.webp')}}" alt="Hero Image" class="img-fluid">
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row gy-4">
                                <div class="col-lg-5">
                                    <div class="profile d-flex align-items-center gap-3">
                                        <img src="{{asset('frontend/img/avatar-1.webp')}}" alt="CEO Profile" class="profile-image">
                                        <div>
                    ...
                    <div class="col-xl-6" data-aos="fade-up" data-aos-delay="300">
                        <div class="image-wrapper">
                            <div class="images position-relative" data-aos="zoom-out" data-aos-delay="400">
                                <img src="{{asset('frontend/img/about-5.webp')}}" alt="Business Meeting"
                                    class="img-fluid main-image rounded-4">
                                <img src="{{asset('frontend/img/about-2.webp')}}" alt="Team Discussion"
                ...
                <div class="tab-content" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="tab-pane fade active show" id="features-tab-1">
                        <div class="row">
                            ...
                            <div class="col-lg-6 order-1 order-lg-2 text-center">
                                <img src="{{asset('frontend/img/features-illustration-1.webp')}}" alt="" class="img-fluid">
                            </div>
                        </div>
                    ...
                    <div class="tab-pane fade" id="features-tab-2">
                        <div class="row">
                            ...
                            <div class="col-lg-6 order-1 order-lg-2 text-center">
                                <img src="{{asset('frontend/img/features-illustration-2.webp')}}" alt="" class="img-fluid">
                            </div>
                        </div>
                    </div><!-- End tab content item -->
                    ...
                    <div class="tab-pane fade" id="features-tab-3">
                        <div class="row">
                            ...
                            <div class="col-lg-6 order-1 order-lg-2 text-center">
                                <img src="{{asset('frontend/img/features-illustration-3.webp')}}" alt="" class="img-fluid">
                            </div>
                        </div>
                    </div><!-- End tab content item -->
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4" data-aos="zoom-in" data-aos-delay="200">
                        <div class="phone-mockup text-center">
                            <img src="{{asset('frontend/img/phone-app-screen.webp')}}" alt="Phone Mockup" class="img-fluid">
                        </div>
    ...
    <footer id="footer" class="footer">
        ...
        <div class="container copyright text-center mt-4">
            ...
            <div class="credits">
                Designed by <a href="https://github.com/dkpankaj1/">CortexItSolution</a>
            </div>
        </div>
