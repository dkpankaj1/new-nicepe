    ...
    public function configure($datatable): DataTableAbstract
    {
        return $datatable
            ...
            ->addColumn('action', function ($user) {
                return view('components.link', ['href' => route('superdistributor.retailers.show', $user->id), 'label' => 'show', 'class' => 'btn btn-sm btn-info']) .
                    view('components.link', ['href' => route('superdistributor.retailers.edit', $user->id), 'label' => 'edit', 'class' => 'btn btn-sm btn-warning']) .
                    view('components.user-btn-delete', ['url' => route('superdistributor.retailers.destroy', $user->id)]);
            });
    }
