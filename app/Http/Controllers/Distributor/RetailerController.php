...
class RetailerController extends Controller
{
    ...
    public function index(Request $request, RetailerDatatable $datatable)
    {
        ...
        return view('shared.retailer.index', [
            'breadcrumb' => Breadcrumbs::render('distributor.retailers.index'),
            'createRetailerUrl' => route('distributor.retailers.create'),
            'ajaxUrl' => route('distributor.retailers.index'),
    ...
    public function create(PlanService $planService)
    {
        return view('shared.retailer.create', [
            ...
            'breadcrumb' => Breadcrumbs::render('distributor.retailers.create'),
