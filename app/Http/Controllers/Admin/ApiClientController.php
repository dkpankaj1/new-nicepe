...
use App\Datatables\Admin\ApiClientDatatable;
...
class ApiClientController extends Controller
{
    ...
    public function __construct(UserService $userService)
    {
        ...
        $this->applyAuthorization([
            'index' => 'api-clients.read',
            'show' => 'api-clients.read',
            'create' => 'api-clients.create',
            'store' => 'api-clients.create',
            'edit' => 'api-clients.edit',
            'update' => 'api-clients.edit',
            'destroy' => 'api-clients.delete',
        ]);
