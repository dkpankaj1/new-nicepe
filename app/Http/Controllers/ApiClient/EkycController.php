...
class EkycController extends Controller
{
    ...
    public function showEkycForm()
    {
        return view('ekyc.ekyc', [
            'title' => 'eKYC',
            'action' => route('apiclient.ekyc.request')
        ]);
    }
    ...
    public function sendEkycOtp(Request $request)
    {
        ...
        try {
            ...
            if ($response['success']) {
                ...
                return redirect()->route('apiclient.ekyc.validate')->with([
    ...
    public function showOtpValidationForm(Request $request)
    {
        ...
        if (!Session::has('ekyc_transaction_id') || !Session::has('aadhaar_number')) {
            return redirect()->route('apiclient.ekyc.request')->withErrors([
        ...
        return view('ekyc.otp', [
            ...
            'action' => route('apiclient.ekyc.validate'),
        ]);
    }
    ...
    public function validateOtp(Request $request)
    {
        ...
        try {
            ...
            if ($response['success']) {
                ...
                return redirect()->route('apiclient.dashboard')->with([
